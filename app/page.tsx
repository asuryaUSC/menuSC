...
export default function LandingPage() {
  ...
  useEffect(() => {
    ...
    const isAndroidChrome =
      ...
      !/OPR|SamsungBrowser|EdgA/i.test(userAgent);
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            Get quick access to USC dining hall menus right from your home
            screen.
          </p>
            ...
            <button
              ...
              onMouseOver={(e) => {
                ...
                e.currentTarget.style.boxShadow =
                  "0 6px 16px rgba(153, 0, 0, 0.25)";
              }}
              onMouseOut={(e) => {
                e.currentTarget.style.transform = "translateY(0px)";
                e.currentTarget.style.boxShadow =
                  "0 4px 14px rgba(153, 0, 0, 0.2)";
              }}
            >
              {primaryButtonText}
            ...
            >
              ...
              {promptType === "ios" && (
                <>
                  ...
                  >
                    <CheckCircle size={15} color="#22c55e" /> Creates an app
                    shortcut!
                  </p>
                </>
              )}
                ...
                <>
                  ...
                  >
                    <li style={{ marginBottom: 8, color: "#333" }}>
                      In <b>Safari:</b> Click File →{" "}
                      <b>&quot;Add to Dock...&quot;</b>
                    </li>
                    <li style={{ color: "#333" }}>
                      In <b>Chrome:</b> Click the{" "}
                      <Download
                        size={15}
                        style={{ display: "inline", marginBottom: -3 }}
                      />{" "}
                      icon → <b>&quot;Install MenuSC...&quot;</b>
                    </li>
                  </ul>
                  <p
                    style={{
                  ...
                  >
                    <CheckCircle size={15} color="#22c55e" /> Adds the app to
